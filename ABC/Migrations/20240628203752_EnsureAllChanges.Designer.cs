...
namespace ABC.Migrations
{
    ...
    [Migration("20240628203752_EnsureAllChanges")]
    partial class EnsureAllChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ABC.Models.Contract", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateFrom = new DateTime(2024, 6, 28, 22, 37, 51, 524, DateTimeKind.Local).AddTicks(3604),
                            DateTo = new DateTime(2024, 7, 18, 22, 37, 51, 524, DateTimeKind.Local).AddTicks(4008),
                            IdClient = 1,
                            IdDiscount = 1,
                            IdSoftwareSystem = 1,
                            IsActive = false,
            ...
            modelBuilder.Entity("ABC.Models.Discount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateFrom = new DateTime(2024, 6, 27, 22, 37, 51, 519, DateTimeKind.Local).AddTicks(8096),
                            DateTo = new DateTime(2024, 7, 8, 22, 37, 51, 523, DateTimeKind.Local).AddTicks(4293),
                            Name = "Black Friday",
                            Value = 20
                        });
                });
            ...
            modelBuilder.Entity("ABC.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2024, 6, 28, 22, 37, 51, 524, DateTimeKind.Local).AddTicks(837),
                            IdClient = 1,
                            IdContract = 1,
                            MoneyAmount = 1000m,
                            isRefunded = false
