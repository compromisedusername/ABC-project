...
namespace ABC.Migrations
{
    ...
    [Migration("20240628132144_AddIsRefundedToPaymentModel")]
    partial class AddIsRefundedToPaymentModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ABC.Models.Contract", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateFrom = new DateTime(2024, 6, 28, 15, 21, 43, 810, DateTimeKind.Local).AddTicks(6220),
                            DateTo = new DateTime(2024, 7, 18, 15, 21, 43, 810, DateTimeKind.Local).AddTicks(6643),
                            IdClient = 1,
                            IdDiscount = 1,
                            IdSoftwareSystem = 1,
                            IsActive = false,
            ...
            modelBuilder.Entity("ABC.Models.Discount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateFrom = new DateTime(2024, 6, 27, 15, 21, 43, 806, DateTimeKind.Local).AddTicks(566),
                            DateTo = new DateTime(2024, 7, 8, 15, 21, 43, 809, DateTimeKind.Local).AddTicks(6504),
                            Name = "Black Friday",
                            Value = 20
                        });
                });
            ...
            modelBuilder.Entity("ABC.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2024, 6, 28, 15, 21, 43, 810, DateTimeKind.Local).AddTicks(3225),
                            IdClient = 1,
                            IdContract = 1,
                            MoneyAmount = 1000m,
                            isRefunded = false
